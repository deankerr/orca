...
/**
 * Public API Preview V2 - Endpoint Transform Layer
 *
...
type DataPolicyOutput = z.infer<typeof DataPolicyOutputSchema>
...
type LimitsOutput = z.infer<typeof LimitsOutputSchema>
...
// * Transform function
function transformEndpointV2(input: Doc<'or_views_endpoints'>): OrcaPublicApiV2Endpoint {
