...
import type * as lib_blobStore from "../lib/blobStore.js";
...
import type * as meps2_adapters_modelEndpointsV1 from "../meps2/adapters/modelEndpointsV1.js";
import type * as meps2_artifacts_records from "../meps2/artifacts/records.js";
import type * as meps2_artifacts_storage from "../meps2/artifacts/storage.js";
import type * as meps2_ingest_mutations from "../meps2/ingest/mutations.js";
import type * as meps2_ingest_queries from "../meps2/ingest/queries.js";
import type * as meps2_ingest_shared from "../meps2/ingest/shared.js";
import type * as meps2_lock from "../meps2/lock.js";
import type * as meps2_orchestrate_drain_apply from "../meps2/orchestrate/drain/apply.js";
import type * as meps2_orchestrate_drain_backfill from "../meps2/orchestrate/drain/backfill.js";
import type * as meps2_orchestrate_drain_onComplete from "../meps2/orchestrate/drain/onComplete.js";
import type * as meps2_orchestrate_drain_start from "../meps2/orchestrate/drain/start.js";
import type * as meps2_orchestrate_drain_workflow from "../meps2/orchestrate/drain/workflow.js";
import type * as meps2_orchestrate_manager from "../meps2/orchestrate/manager.js";
import type * as meps2_orchestrate_observe_action from "../meps2/orchestrate/observe/action.js";
import type * as meps2_orchestrate_observe_onComplete from "../meps2/orchestrate/observe/onComplete.js";
import type * as meps2_orchestrate_observe_start from "../meps2/orchestrate/observe/start.js";
import type * as meps2_orchestrate_observe_workflow from "../meps2/orchestrate/observe/workflow.js";
import type * as meps2_projections_apply from "../meps2/projections/apply.js";
import type * as meps2_projections_chunks from "../meps2/projections/chunks.js";
import type * as meps2_projections_compare from "../meps2/projections/compare.js";
import type * as meps2_projections_explode from "../meps2/projections/explode.js";
import type * as meps2_projections_flatten from "../meps2/projections/flatten.js";
import type * as meps2_projections_writes_endpoints from "../meps2/projections/writes/endpoints.js";
import type * as meps2_projections_writes_helpers from "../meps2/projections/writes/helpers.js";
import type * as meps2_projections_writes_models from "../meps2/projections/writes/models.js";
import type * as meps2_projections_writes_pricing from "../meps2/projections/writes/pricing.js";
import type * as meps2_projections_writes_providers from "../meps2/projections/writes/providers.js";
import type * as meps2_projections_writes_stats from "../meps2/projections/writes/stats.js";
import type * as meps2_scan_scan from "../meps2/scan/scan.js";
import type * as meps2_scan_scanArtifact from "../meps2/scan/scanArtifact.js";
import type * as meps2_tables_artifacts from "../meps2/tables/artifacts.js";
import type * as meps2_tables_endpoints from "../meps2/tables/endpoints.js";
import type * as meps2_tables_ingestWindow from "../meps2/tables/ingestWindow.js";
import type * as meps2_tables_locks from "../meps2/tables/locks.js";
import type * as meps2_tables_models from "../meps2/tables/models.js";
import type * as meps2_tables_pricing from "../meps2/tables/pricing.js";
import type * as meps2_tables_providers from "../meps2/tables/providers.js";
import type * as meps2_tables_scans from "../meps2/tables/scans.js";
import type * as meps2_tables_shared from "../meps2/tables/shared.js";
import type * as meps2_tables_stats from "../meps2/tables/stats.js";
...
declare const fullApi: ApiFromModules<{
  ...
  http: typeof http;
  init: typeof init;
  "lib/blobStore": typeof lib_blobStore;
  "lib/env": typeof lib_env;
  "lib/functionSpec": typeof lib_functionSpec;
  "lib/paginateAndProcess": typeof lib_paginateAndProcess;
  "lib/r2": typeof lib_r2;
  "meps2/adapters/modelEndpointsV1": typeof meps2_adapters_modelEndpointsV1;
  "meps2/artifacts/records": typeof meps2_artifacts_records;
  "meps2/artifacts/storage": typeof meps2_artifacts_storage;
  "meps2/ingest/mutations": typeof meps2_ingest_mutations;
  "meps2/ingest/queries": typeof meps2_ingest_queries;
  "meps2/ingest/shared": typeof meps2_ingest_shared;
  "meps2/lock": typeof meps2_lock;
  "meps2/orchestrate/drain/apply": typeof meps2_orchestrate_drain_apply;
  "meps2/orchestrate/drain/backfill": typeof meps2_orchestrate_drain_backfill;
  "meps2/orchestrate/drain/onComplete": typeof meps2_orchestrate_drain_onComplete;
  "meps2/orchestrate/drain/start": typeof meps2_orchestrate_drain_start;
  "meps2/orchestrate/drain/workflow": typeof meps2_orchestrate_drain_workflow;
  "meps2/orchestrate/manager": typeof meps2_orchestrate_manager;
  "meps2/orchestrate/observe/action": typeof meps2_orchestrate_observe_action;
  "meps2/orchestrate/observe/onComplete": typeof meps2_orchestrate_observe_onComplete;
  "meps2/orchestrate/observe/start": typeof meps2_orchestrate_observe_start;
  "meps2/orchestrate/observe/workflow": typeof meps2_orchestrate_observe_workflow;
  "meps2/projections/apply": typeof meps2_projections_apply;
  "meps2/projections/chunks": typeof meps2_projections_chunks;
  "meps2/projections/compare": typeof meps2_projections_compare;
  "meps2/projections/explode": typeof meps2_projections_explode;
  "meps2/projections/flatten": typeof meps2_projections_flatten;
  "meps2/projections/writes/endpoints": typeof meps2_projections_writes_endpoints;
  "meps2/projections/writes/helpers": typeof meps2_projections_writes_helpers;
  "meps2/projections/writes/models": typeof meps2_projections_writes_models;
  "meps2/projections/writes/pricing": typeof meps2_projections_writes_pricing;
  "meps2/projections/writes/providers": typeof meps2_projections_writes_providers;
  "meps2/projections/writes/stats": typeof meps2_projections_writes_stats;
  "meps2/scan/scan": typeof meps2_scan_scan;
  "meps2/scan/scanArtifact": typeof meps2_scan_scanArtifact;
  "meps2/tables/artifacts": typeof meps2_tables_artifacts;
  "meps2/tables/endpoints": typeof meps2_tables_endpoints;
  "meps2/tables/ingestWindow": typeof meps2_tables_ingestWindow;
  "meps2/tables/locks": typeof meps2_tables_locks;
  "meps2/tables/models": typeof meps2_tables_models;
  "meps2/tables/pricing": typeof meps2_tables_pricing;
  "meps2/tables/providers": typeof meps2_tables_providers;
  "meps2/tables/scans": typeof meps2_tables_scans;
  "meps2/tables/shared": typeof meps2_tables_shared;
  "meps2/tables/stats": typeof meps2_tables_stats;
